...
using MyResume.Domain.Business.ResumeModel.Skill;
...
namespace MyResume.WebUI.Areas.Admin.Controllers
{
    ...
    public class ResumeSkillsController : Controller
    {
        ...
        public ResumeSkillsController(MyResumeDbContext db, IMediator mediator)
        {
            this.db = db;
        ...
        {
            ViewData["ResumeCategoryId"] = new SelectList(db.ResumeCategorys, "Id", "Name");
        ...
        public async Task<IActionResult> Create(ResumeSkillPostCommand command)
        {
            ...
            ViewData["ResumeCategoryId"] = new SelectList(db.ResumeCategorys, "Id", "Name", command.ResumeCategoryId);
            return View(command);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["ResumeCategoryId"] = new SelectList(db.ResumeCategorys, "Id", "Name", editCommand.ResumeCategoryId);
